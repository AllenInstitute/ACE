...
descriptions   <- c(
  ...
  "Human MTG data set comparisons (recent). Cluster and other assignments for the SAME set of ~135K cells collected from MTG that were used in four published studies, including in SEA-AD and the whole human brain. These studies are (1) the human 'great ape' (GA) study (Jorstad, Song, Exposito-Alonso, et al 2023, DOI:10.1126/science.ade9516), which assesses cell types in MTG across species; (2) the human 'cross-areal' (CA) study (Jorstad et al 2023, DOI:10.1126/science.adf6812), which assesses cell types across multiple neocortical areas in human (including MTG); (3) 'SEA-AD' calls for each level of the taxonomy in MTG (Gabitto, Travaglini, et al 2023; DOI:10.1101/2023.05.08.539485)' and (4) a draft atlas of all cell types in the human brain (Siletti et al 2023; DOI:10.1126/science.add7046). The latter two of these studies are currently available on both MapMyCells and the ABC Atlas. Note: the clusters in the GA study represented the starting point for analysis in generation of the SEA-AD supertypes.  All three MTG-focused data sets in this table were generated using a nearly identical set of ~135K cells collected using 10X genomics single nucleus RNA-seq technologies, and only the matching subset of ~75K cells from the whole human brain study have included cluster assignments. Clusters from the GA and CA studies and superclusters from the WHB are appended with '_GA', '_CA', and '_WHB', respectively, for ACE functionality.",
