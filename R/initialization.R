...
table_names <- c(
  ...
  "Multiple neocortical brain regions",
  ...
  "HMBA whole brain: Human",
  "HMBA whole brain: Macaque",
  "HMBA whole brain: Marmoset"
)
...
table_locations <- c(
  ...
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/CAvsWHB_cell_info.csv.gz",
  ...
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/HMBA_WB_human_cluster_annotation.csv.gz",
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/HMBA_WB_macaque_cluster_annotation.csv.gz",
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/HMBA_WB_marmoset_cluster_annotation.csv.gz"
)
...
metadata_locations <- c(
  ...
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/WMB_cluster_annotations.csv.gz",
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/HMBA_WB_celltypes.csv.gz",
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/HMBA_WB_celltypes.csv.gz",
  "https://raw.githubusercontent.com/AllenInstitute/ACE/main/data/HMBA_WB_celltypes.csv.gz"
)
...
descriptions   <- c(
  ...
  "Multiple human neocortical brain regions. Cluster and other assignments for the SAME set of cells collected from five neocortical regions (A1C, M1C, MTG, S1C, V1C) that were used in two separate studies. These studies are (1) the human 'cross-areal' (CA) study (Jorstad et al 2023, DOI:10.1126/science.adf6812), which assesses cell types across multiple neocortical areas in human and (2) a draft atlas of all cell types in the human brain (Siletti et al 2023; DOI:10.1126/science.add7046). The latter study is currently available on both MapMyCells and the ABC Atlas. Note: cluster names are appended with '_CA_[region/all]' and '_WHB', respectively, for ACE functionality.",
  ...
  "The Human and Mammalian Brain Atlas (HMBA) has created a cross-species whole-brain single-cell RNA-seq taxonomy spanning human, macaque, and marmoset, referenced to the mouse and human whole-brain taxonomies (Yao et al., Siletti et al.). This table shows relationships between cell type annotations for a subsampled set of ~200,000 cells from HUMAN brain to see how cell type assignments compare across studies. While publicly accessible, this table is primarily intended for folks in the BRAIN Initiative Cell Atlas Network (BICAN) to aid in cluster annotation. See https://alleninstitute.github.io/HMBA_WB_Atlas/ for more information about this project.",
  
  "The Human and Mammalian Brain Atlas (HMBA) has created a cross-species whole-brain single-cell RNA-seq taxonomy spanning human, macaque, and marmoset, referenced to the mouse and human whole-brain taxonomies (Yao et al., Siletti et al.). This table shows relationships between cell type annotations for a subsampled set of ~200,000 cells from MACAQUE brain to see how cell type assignments compare across studies. While publicly accessible, this table is primarily intended for folks in the BRAIN Initiative Cell Atlas Network (BICAN) to aid in cluster annotation. See https://alleninstitute.github.io/HMBA_WB_Atlas/ for more information about this project.",
  
  "The Human and Mammalian Brain Atlas (HMBA) has created a cross-species whole-brain single-cell RNA-seq taxonomy spanning human, macaque, and marmoset, referenced to the mouse and human whole-brain taxonomies (Yao et al., Siletti et al.). This table shows relationships between cell type annotations for a subsampled set of ~200,000 cells from MARMOSET brain to see how cell type assignments compare across studies. While publicly accessible, this table is primarily intended for folks in the BRAIN Initiative Cell Atlas Network (BICAN) to aid in cluster annotation. See https://alleninstitute.github.io/HMBA_WB_Atlas/ for more information about this project."
